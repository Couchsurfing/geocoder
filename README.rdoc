...
Alternatively, if you want Geocoder to raise an error every time there's an issue, you can set <tt>always_raise</tt> to <tt>true</tt>:

  Geocoder::Configuration.always_raise = true
